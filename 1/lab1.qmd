...
- Understanding the relation between the centrality of a twitter user (proxied
by the number of followers) and the number of retweets sounds like a regression problem. Since we are interested in understanding this is an inference problem.
- Predicting wether a student will drop out or not is a classification problem. Since we are interested in prediction this is a predicting problem. 
