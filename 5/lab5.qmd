...
bootstrap <- function(corp, B = 20, word){

  B <- B # number of bootstraps (minimum of 20 for 90% confidence interval)
  word_ranks <- c() # to store each bootstrap's rank
  for(b in 1:B){
    ...
    word_ranks[b] <- neg_assoc_terms[term2==word]$rank
    
    # Print iteration
    print(paste0('Bootstrap ',b,' finished. Rank: ', word_ranks[b]))
  }
