...
# Compare the prevalence on your labeled topics between democrats and republicans. 
# You can for 4example fit a fractional regression model using glm(family="quasibinomial") or using t-tests of difference in means. Interpret.
