...
The skewness of the plot is lower, indicating a more stable distribution of leafs, when ignoring the 2 that have a super high propensityscoredifference.
...
par(mfrow = c(1, 1)); plot(leaf_pcs$PC1, leaf_pcs$PC2, 
     pch = 19, cex = 2, col = "steelblue",
     xlab = "PC1", ylab = "PC2",
     main = "Leaf Centroids in PC Space"); text(leaf_pcs$PC1, leaf_pcs$PC2, labels = leaf_pcs$leaf_2, pos = 2)
```
...
barplot(sort(pca$rotation[, 1]), horiz = TRUE, las = 1,
        col = "steelblue4", main = "PC1 Loadings")
abline(v = 0, lty = 2)

# PC2
barplot(sort(pca$rotation[, 2]), horiz = TRUE, las = 1,
        col = "steelblue4", main = "PC2 Loadings")
abline(v = 0, lty = 2)
